                            ...
                            <div class="col-lg-12">
                                <div class="tabs-container">
                                    <ul class="nav nav-tabs">
                                        <li class="active">
                                            <a href="#tab-1" data-toggle="tab">Subprocesos
                                            </a>
                                        </li>
                                    </ul>
    ...
    <div class="modal fade" id="myModalHorizontal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="form-horizontal" role="form" method="post" action="{{URL::to('subproceso/guardar')}}">
                    <!-- Modal Body -->
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-horizontal">
                            {{csrf_field()}}
                            <input type="hidden" name="codProMA" value="{{$procesoma->codProMA}}">
                            <div class="form-group">
                                <label  class="col-sm-2 control-label"
                                        for="inputEmail3">Subproceso</label>
                                <div class="col-sm-10">
