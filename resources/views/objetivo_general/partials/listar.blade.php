    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-content">
                <div class="row">
                    <div class="col-sm-3">
                        <a type="button" href="{!! url('procedimiento/crear-general/'.$auditoria->objetivoGeneral->codObjGen) !!}" class="btn btn-sm btn-success btn-outline"><i class="fa fa-pencil"></i> CREAR PROCEDIMIENTO</a>
                    </div>
                </div>
